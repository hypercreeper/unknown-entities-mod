...
public class TesterItem extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:tester")
	public static final Item block = null;
	public TesterItem(EntitiesOfTheUnknownModElements instance) {
		super(instance, 55);
	}
