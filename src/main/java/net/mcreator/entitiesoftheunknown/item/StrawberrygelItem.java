...
public class StrawberrygelItem extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:strawberrygel")
	public static final Item block = null;
	public StrawberrygelItem(EntitiesOfTheUnknownModElements instance) {
		super(instance, 35);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("use it to make something tasty"));
		}
	}
}
