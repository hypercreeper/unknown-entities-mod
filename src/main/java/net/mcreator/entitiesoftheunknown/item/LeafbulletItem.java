...
public class LeafbulletItem extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:leafbullet")
	public static final Item block = null;
	public LeafbulletItem(EntitiesOfTheUnknownModElements instance) {
		super(instance, 21);
	}
