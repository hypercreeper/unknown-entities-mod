...
public class BlackberrygelItem extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:blackberrygel")
	public static final Item block = null;
	public BlackberrygelItem(EntitiesOfTheUnknownModElements instance) {
		super(instance, 39);
	}
