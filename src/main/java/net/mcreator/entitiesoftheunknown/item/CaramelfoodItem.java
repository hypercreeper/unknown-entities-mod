...
public class CaramelfoodItem extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:caramelfood")
	public static final Item block = null;
	public CaramelfoodItem(EntitiesOfTheUnknownModElements instance) {
		super(instance, 16);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("so tasty but so sticky once its on your clothes"));
		}
	}
}
