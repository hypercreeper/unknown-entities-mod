...
public class LemongelItem extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:lemongel")
	public static final Item block = null;
	public LemongelItem(EntitiesOfTheUnknownModElements instance) {
		super(instance, 43);
	}
