...
import net.mcreator.entitiesoftheunknown.item.LeafbulletItem;
import net.mcreator.entitiesoftheunknown.item.LeafbowItem;
import net.mcreator.entitiesoftheunknown.item.LeafAxeItem;
	...
	public static class CustomEnchantment extends Enchantment {
		...
		public boolean canApplyAtEnchantingTable(ItemStack stack) {
			...
			if (stack.getItem() == LeafbowItem.block)
				return true;
			if (stack.getItem() == LeafAxeItem.block)
				return true;
			if (stack.getItem() == LeafbulletItem.block)
				return true;
			return false;
		}
