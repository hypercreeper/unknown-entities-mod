...
public class GlowflowerBlock extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:glowflower")
	public static final Block block = null;
	public GlowflowerBlock(EntitiesOfTheUnknownModElements instance) {
		super(instance, 48);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glowflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("entities_of_the_unknown:glowflower"), configuredFeature);
		}
	}
	@SubscribeEvent
