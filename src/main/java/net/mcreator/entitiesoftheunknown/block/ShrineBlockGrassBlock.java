...
public class ShrineBlockGrassBlock extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:shrine_block_grass")
	public static final Block block = null;
	public ShrineBlockGrassBlock(EntitiesOfTheUnknownModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("shrine_block_grass");
		}
