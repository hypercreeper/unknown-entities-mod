...
public class SoulLogBlock extends EntitiesOfTheUnknownModElements.ModElement {
	@ObjectHolder("entities_of_the_unknown:soul_log")
	public static final Block block = null;
	public SoulLogBlock(EntitiesOfTheUnknownModElements instance) {
		super(instance, 61);
	}
